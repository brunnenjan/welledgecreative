...
export const metadata: Metadata = {
  ...
  title: "Well Edge Creative | Branding & Webdesign von Jan Brunnenkant",
  description: "Strategie mit Tiefe, Design mit Klarheit. Ich erschaffe Marken und Websites, die deine Geschichte erzählen und deine Zielgruppe erreichen.",
  keywords: [
    "branding",
    "webdesign",
    "logodesign",
    ...
    images: [
      {
        ...
        width: 2688,
        height: 1792,
        alt: "Well Edge Creative — Branding & Webdesign",
      },
    ],
  },
  twitter: {
