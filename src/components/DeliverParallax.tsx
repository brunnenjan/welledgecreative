...
export default function DeliverParallax() {
  ...
  const [bgSrc, setBgSrc] = useState("/assets/parallax/section-deliver/parallax-bg-deliver.webp");
  ...
  useEffect(() => {
    ...
    const checkViewport = () => {
      ...
      setIsMobile(mobile);
      setIsTablet(tablet);
      setBgSrc(getBackgroundSrc("/assets/parallax/section-deliver/parallax-bg-deliver", mobile));
    };
